...
Currently at initial stage mostly... but the end goal is to provide a chat platform which could use AI to simulate conversation as if in a narrative psychology session...
